...
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified tipPercent;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified billText;
